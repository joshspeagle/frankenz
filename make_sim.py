...
class survey():
    ...
    def LoadFilters(self, filter_list, path='', Npoints=5e4):
        """
        ...
        self.fw = [0.]*self.NFILTER # wavelength
    ...
    def LoadDepth(self, depth_list, depths):
        ...
        self.FDEPTHS = 10**((23.9-depth_list) / -2.5) / depths # 1-sigma noise level [uJy]
    ...
    def LoadPrior(self, p_tz_m, p_t_m, p_m, mag_ref):
        """
    ...
    def SamplePrior(self, Ndraws):
        """
        Draw Ndraws samples from the joint P(t,z,m) prior.
        """

        sys.stdout.write('Sampling mags...')
        mags = draw_mag(Ndraws, self.prior_p_m, self.MDEPTHS[self.mag_ref])
        ...
        redshifts = draw_redshift_type_mag(self.prior_tz_m, types, mags)
        sys.stdout.write('done!\n')
